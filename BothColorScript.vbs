...
Sub StockData():
    ...
    For y = 2 To LastRow
        If ws.Cells(y, 11) > 0 Then
            ws.Cells(y, 11).Interior.ColorIndex = 4
        ElseIf ws.Cells(y, 11) < 0 Then
            ws.Cells(y, 11).Interior.ColorIndex = 3
        Else
            ws.Cells(y, 11).Interior.ColorIndex = 0
        End If
